...
```powershell
conda run -n chroma-db-import python -m chroma_db_import --update --dry-run
conda run -n chroma-db-import python -m chroma_db_import --update --reconcile --allow-delete-missing
```
